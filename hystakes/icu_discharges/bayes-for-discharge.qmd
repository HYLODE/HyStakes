...
```
We observe that X patients out of N were discharged. This provides our likelihood. We can express our data as a binomial distribution as follows where we do N trials with an our unknown probability $\theta$
...
line1, = ax.plot(x, beta.pdf(x, a, b),
       'r-', lw=2, alpha=0.6, label='prior')
line2, = ax.plot(x, beta.pdf(x, a_prime, b_prime),
